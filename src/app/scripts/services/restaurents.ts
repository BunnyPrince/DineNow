/**
 * Module initializes rest service restaurents
 */
import {
    Injectable
} from '@angular/core';
...
class restaurents {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.removeUndefined(this.entityAPI.get("restaurents.request.headers", reqOpts.headers, true)),
            params: this.entityAPI.removeUndefined(this.entityAPI.get("restaurents.request.query", reqOpts.params, true)),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "restaurents"
            }
        };
