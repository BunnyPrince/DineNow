/**
 * Module initializes rest service DineNowDB_tables_read_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class DineNowDB_tables_read_service {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.removeUndefined(this.entityAPI.get("DineNowDB_tables_read_service.request.headers", reqOpts.headers, true)),
            params: this.entityAPI.removeUndefined(this.entityAPI.get("DineNowDB_tables_read_service.request.query", reqOpts.params, true)),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "DineNowDB_tables_read_service"
            }
        };
...
*/
export {
    DineNowDB_tables_read_service as ExportedClass
};