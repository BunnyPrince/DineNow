/**
 * Module initializes rest service DineNowDB_tables_query_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class DineNowDB_tables_query_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/db/collections/tables/query",
            method: "post",
            headers: this.entityAPI.removeUndefined(this.entityAPI.get("DineNowDB_tables_query_service.request.headers", reqOpts.headers, true)),
            params: this.entityAPI.removeUndefined(this.entityAPI.get("DineNowDB_tables_query_service.request.query", reqOpts.params, true)),
            data: this.entityAPI.get("DineNowDB_tables_query_service.request.body", reqOpts.data, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "DineNowDB_tables_query_service"
            }
        };
...
*/
export {
    DineNowDB_tables_query_service as ExportedClass
};